...
export const SUBJECT = `You've been added to a project on Switchboard`;
          ...
          <tr>
            <td style="padding:32px 32px 16px;">
              ...
              <p style="margin:16px 0 0;font-size:15px;line-height:24px;color:#4b5563;">
                <strong>{{addedBy}}</strong> added you to the project <strong>{{projectName}}</strong> on {{platformName}}.
              </p>
            </td>
          </tr>
          <tr>
            <td style="padding:8px 32px 24px;">
              <p style="margin:0;font-size:15px;line-height:24px;color:#4b5563;">
                You can now access flags, environments, and API keys for this project.
              </p>
            </td>
          </tr>
        </table>
