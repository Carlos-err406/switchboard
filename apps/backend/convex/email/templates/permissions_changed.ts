...
export const SUBJECT = `Your Switchboard permissions were updated`
          ...
          <tr>
            <td style="padding:32px 32px 16px;">
              ...
              <p style="margin:16px 0 0;font-size:15px;line-height:24px;color:#4b5563;">
                The platform permissions for <strong>{{email}}</strong> on {{platformName}} were updated by an administrator.
              </p>
            </td>
          </tr>
          <tr>
            <td style="padding:8px 32px 24px;">
              <p style="margin:0;font-size:15px;line-height:24px;color:#4b5563;">
                If you have questions about your access, please contact your administrator.
              </p>
            </td>
          </tr>
        </table>
