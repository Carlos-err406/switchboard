...
export const SUBJECT = `Your project permissions were updated on Switchboard`;
          ...
          <tr>
            <td style="padding:32px 32px 16px;">
              ...
              <p style="margin:16px 0 0;font-size:15px;line-height:24px;color:#4b5563;">
                Your permissions on the project <strong>{{projectName}}</strong> were updated on {{platformName}}.
              </p>
            </td>
          </tr>
          <tr>
