...
export const SUBJECT = `Your Switchboard account has been locked`;
          ...
          <tr>
            <td style="padding:32px 32px 16px;">
              ...
              <p style="margin:16px 0 0;font-size:15px;line-height:24px;color:#4b5563;">
                Your account <strong>{{email}}</strong> on {{platformName}} has been locked by an administrator.
              </p>
            </td>
          </tr>
          <tr>
            <td style="padding:8px 32px 24px;">
              <p style="margin:0;font-size:15px;line-height:24px;color:#4b5563;">
                While your account is locked you will not be able to sign in. If you believe this is a mistake, please contact your administrator.
              </p>
            </td>
          </tr>
        </table>
